...
if(isset($_GET['idOfDesigner'])){ 
        $id =$_GET['idOfDesigner'];  //from the query string  
} 
?>
...
<head> 
  <meta charset="utf-8"> 
  <title>Decora - Add new Project</title> 
  <style> 
...
$query = "INSERT INTO designportoflioproject (designerID, projectName, projectImgFileName, description, designCategoryID) VALUES ('$id', '$projN', '$imgName', '$description', '$category')";
      ...
      <?php
       ...
       // $idOfUser =$id;        //$_GET['id']
        ...
        $sql2 = "SELECT designerCategoryID FROM designerspeciality WHERE designerID = " . $id;
        $row2;
    ...
    <main> 
      <h1 id="add-title">Add New Project</h1> 
      <div class="container"> 
        ...
        <form action="add.php" method="post" id="add-form" enctype="multipart/form-data"> 
            ...
            <div id="firstRow"> 
                <label>Project Name: <input type="text" name="projN" id="projN" required></label> 
           ...
           ?> 
                ...
                <textarea name="description" id="description-area" rows="6" cols="58" required></textarea> 
                <br> 
 
                <input class="button" id="add-btn"  type="submit" value="Add"> 
                <button class="button" name="cancle" value="cancle" onclick="">Cancel</button> 
